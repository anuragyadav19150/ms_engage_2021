...
class CallPage extends StatefulWidget {
  ...
  CallPage(channelName, role, _channelController1, _channelControllerLog1) {
  ...
  _CallPageState createState() =>
      _CallPageState(_channelController, _channelControllerLog);
}
...
class _CallPageState extends State<CallPage> {
  ...
  _CallPageState(_channelController1, _channelControllerLog1) {
    this._channelController = _channelController1;
    this._channelControllerLog = _channelControllerLog1;
  }
  ...
  Widget _toolbar() {
    ...
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.fromLTRB(0, 525, 0, 0),
        child: Column(
          children: [
            Row(
                  ...
                  children: [
                    Flexible(
                      child: Container(
                        ...
                        child: Text(
                          "Name - " + _channelControllerLog.text,
  ...
  void _onMsg() {
    setState(() {
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              MyApp1(_channelController, _channelControllerLog),
        ),
      );
    });
  }
